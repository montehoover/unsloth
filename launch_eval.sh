...
python scripts/eval.py --sample_size 1 --dataset_path tomg-group-umd/compliance --subset wildguard  --model /fs/cml-projects/guardian_models/models/Llama-Guard-3-8B/huggingface_sft/lora_wildguard
...
python scripts/eval.py --sample_size 1 --dataset_path tomg-group-umd/compliance --subset wildguard  --model /fs/cml-projects/guardian_models/models/Meta-Llama-3.1-8B-Instruct/huggingface_grpo/lora_multirule_v2
python scripts/eval.py --sample_size 1 --dataset_path tomg-group-umd/compliance --subset wildguard  --model /fs/cml-projects/guardian_models/models/Meta-Llama-3.1-8B-Instruct/huggingface_grpo/lora_wildguard
