...
#   bax.scatter(size, accuracy, color='#1f77b4', yerr=error/2, marker='o', ms=14, # capsize=5, label=label)
...
bax.axs[0].set_xticks([1.0, 3.0, 9.0, 27.0, 70.0, 200, 600], ['1B', '3B', '9B', '27B', '70B', '200B', '600B'], rotation=0)
