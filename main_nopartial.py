...
def get_grpo_trainer(args, model, tokenizer, run_name):
    ...
    dataset = get_compliance_examples(args.dataset, args.subset)
...
def parse_args():
    ...
    model_group.add_argument('--dataset', type=str, default="data/multirule/multi_rule_train_1704_cot.jsonl", help="Huggingface dataset to use for training")
    model_group.add_argument('--subset', type=str, default=None, help="Subset of the dataset to use for training")
    ...
    training_group.add_argument('--gradient_accumulation_steps', type=int, default=4, help="Number of gradient accumulation steps, default is 1. Increase to 4 for smoother training.")
    ...
    training_group.add_argument('--learning_rate', type=float, default=5e-5, help="Learning rate, default is 2e-4.")
