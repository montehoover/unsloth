...
# # python main.py --max_grad_norm 0.2 --lr_scheduler_type cosine --num_generations 18 --gradient_accumulation_steps 1 --learning_rate 1e-6 #CUDA OOM on rtxa5000 for 8B model
...
# Qwen sweep round 2
python main.py --max_grad_norm 0.2 --lr_scheduler_type cosine --num_generations 16 --gradient_accumulation_steps 4 --learning_rate 1e-4
python main.py --max_grad_norm 0.2 --lr_scheduler_type cosine --num_generations 32 --gradient_accumulation_steps 4 --learning_rate 1e-4
python main.py --max_grad_norm 0.2 --lr_scheduler_type cosine --num_generations 64 --gradient_accumulation_steps 4 --learning_rate 1e-4

python main.py --max_grad_norm 0.2 --lr_scheduler_type cosine --num_generations 16 --gradient_accumulation_steps 4 --learning_rate 3e-4
python main.py --max_grad_norm 0.2 --lr_scheduler_type cosine --num_generations 28 --gradient_accumulation_steps 4 --learning_rate 3e-4
python main.py --max_grad_norm 0.2 --lr_scheduler_type cosine --num_generations 32 --gradient_accumulation_steps 4 --learning_rate 3e-4

python main.py --max_grad_norm 0.2 --lr_scheduler_type cosine --num_generations 16 --gradient_accumulation_steps 4 --learning_rate 5e-4
python main.py --max_grad_norm 0.2 --lr_scheduler_type cosine --num_generations 28 --gradient_accumulation_steps 4 --learning_rate 5e-4
python main.py --max_grad_norm 0.2 --lr_scheduler_type cosine --num_generations 32 --gradient_accumulation_steps 4 --learning_rate 5e-4

# python main.py --max_grad_norm 0.2 --lr_scheduler_type constant_with_warmup --warmup_steps 10 --warmup_ratio 0 --num_generations 12 --gradient_accumulation_steps 4 --learning_rate 1e-4
# python main.py --max_grad_norm 0.2 --lr_scheduler_type constant_with_warmup --warmup_steps 20 --warmup_ratio 0 --num_generations 12 --gradient_accumulation_steps 4 --learning_rate 1e-4
# python main.py --max_grad_norm 0.2 --lr_scheduler_type constant_with_warmup --warmup_steps 30 --warmup_ratio 0 --num_generations 12 --gradient_accumulation_steps 4 --learning_rate 1e-4
